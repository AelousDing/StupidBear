...
namespace StupidBear.Core.Dialogs;
...
public class DialogException : Exception
{
    ...
    /// <summary>
    /// The <see cref="DialogException"/> Message returned when StupidBear.Core is unable to locate the backing field or setter for the <see cref="DialogCloseListener"/>.
    /// </summary>
